export const perguntas = [
    {
        enunciado: "Você desperdiça muitos alimentos em sua casa?",
        alternativas: [
            {
                texto: "sim",
                afirmacao: [
                    "Vamos modificar esse costume para que você não desperdice mais alimentos em sua casa",
    ...
    {
        enunciado: "Vamos utilizar receitas de reaproveitamento! Qual você prefere ?",
        alternativas: [
            {
                texto: "Doce.",
                afirmacao: [
                    "Sugere-se que reapreoveite as cascas de laranja para a producão de compotas."
            ...
            },
            {
                texto: "Salgada.",
                afirmacao: [
                    "sugere-se que reaproveite as cascas de abóbora e ameixa para a preparação de saladas."
    ...
    {
        enunciado: "você gostou da ideia",
        alternativas: [
            {
                texto: "Sim.",
                afirmacao: [
    ...
    {
        enunciado: "Vai utilizar esse método em sua casa?",
        alternativas: [
            {
                texto: "Sim.",
                afirmacao: [
    ...
    {
        enunciado: "você tambem pode achar mais receitas na internet",
        alternativas: [
            {
                texto: "Sim.",
                afirmacao: [
    ...
    {
        enunciado: "Que tal compartilha-las com amigos e familiares ?",
        alternativas: [
            {
                texto: "acho uma ótima ideia.",
                afirmacao: [
                    "Vem impulsionando a inovação na área de IA e luta para abrir novos caminhos profissionais com IA.",
                    "Participa ativamente do desenvolvimento de soluções criativas e na melhoria de processos em IA."
                ],
    ...
    {
        enunciado: "È muito importante que compartilhe, pois assim estaremos ajudando a termos um futuro melhor concorda?",
        alternativas: [
            {
                texto: "sim.",
                afirmacao: [
    ...
    {
        enunciado: "concluindo, o que achou dessa pesquisa?",
        alternativas: [
            {
                texto: "Muito boa!.",
                afirmacao: [
